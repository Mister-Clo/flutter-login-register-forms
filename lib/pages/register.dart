  ...
  void register() async {
    if (_key.currentState.validate()) {
      final response = await AuthService.register(
          nom_inscription.text,
          prenom_inscription.text,
          email_inscription.text,
      ...
      if (response["statut"] == 1) {
        ...
        Navigator.of(context)
            .push(MaterialPageRoute(builder: (g) => Wrapper()));
        setState(() {});
      } else {
        registered = false;
        message = response["message"];
                    ...
                    child: Column(
                      children: [
                        ...
                        Card(
                          child: TextFormField(
                            validator: (e) =>
                                e.isEmpty ? "Veuillez entrer le nom" : null,
                        ...
                        Card(
                          child: TextFormField(
                            validator: (e) =>
                                e.isEmpty ? "Veuillez entrer le prénom" : null,
                        ...
                        Card(
                          child: TextFormField(
                            validator: (e) =>
                                e.isEmpty ? "Veuillez entrer le numéro" : null,
